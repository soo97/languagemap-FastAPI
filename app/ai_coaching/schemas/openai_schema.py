...
class CoachingScriptRequest(BaseModel):
    ...
    scenarioPrompt: str = Field(..., json_schema_extra={"example": "Practice ordering coffee politely."})
    evaluation: str = Field(default="", json_schema_extra={"example": "발음은 보통이고 표현은 자연스러움"})
